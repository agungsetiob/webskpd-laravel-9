...
class RegisteredUserController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        // $image->storeAs('public/ava', $image->getClientOriginalName().$image->hashName());
    ...
    public function storeUser(Request $request)
    {
        ...
        $user = User::create([
            ...
            'role' => 'user',
            'status' => 'inactive',
            'avatar' => $image->getClientOriginalName().$image->hashName(),
        ]);
    ...
    public function update($id, Request $request)
    {
        ...
        if ($request->hasFile('avatar')) {
            ...
            Storage::delete('public/ava/'.$user->image);
            $user->update([
                'name' => $request->name,
                'username' => $request->username,
