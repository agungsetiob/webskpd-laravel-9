                    ...
                    <div class="card-body">
                        <form action="{{ route('posts.update', $post->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="file" class="form-control" name="image" value=" {{ old('image',$post->image) }} ">
                            ...
                            <div class="form-group">
                                <label class="font-weight-bold">kategori</label>
                                    <select name="category" class="form-control combobox btn-default" required value="{{ old('category', $post->category) }}">
