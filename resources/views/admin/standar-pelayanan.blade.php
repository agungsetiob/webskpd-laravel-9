...
<body id="page-top">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Standar Pelayanan</h1>
                        @if (Auth::user()->role == 'admin')
                        <a href="#{{ route('posts.create') }}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" data-toggle="modal" data-target="#uploadSP"><i class="fas fa-upload fa-sm text-white-50"></i> Upload Standar Pelayanan</a>
                        @endif
                    </div>
                </div>
                 <!-- Begin Page Content -->
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Daftar Standar Pelayanan</h6>
                        </div>
                        <div class="card-body">
                                ...
                                <table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-danger btn-sm" title="hapus" href="#" data-toggle="modal" data-target="#deleteModal" onclick="deleteSP({{$file->id}})">
                                                <i class="fas fa-trash"></i>
                                                </a>
                                                <a class="btn btn-success btn-sm" title="download" href="{{Storage::url('sp/'. $file->file )}}" target="_blank">
    ...
    <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
     ...
     <!-- Add Modal -->
    <div class="modal fade" id="uploadSP" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Upload Standar Pelayanan</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form action="{{ url('upload/standar-pelayanan') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group">
                            <label for="name">Unit name</label>
                            <input type="text" name="name" class="form-control" id="name" required>
                            <label for="name">Service name</label>
                            <input type="text" name="service_name" class="form-control" id="Specialization" required>
    ...
    <script>
        function deleteSP(id){
            ...
            link.href = "{{ url('delete/standar-pelayanan')}}/" + id
