            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Survey Kepuasan Masyarakat</h1>
                        @foreach ($posts as $post)
                        <a href="{{ route('posts.edit', $post->id) }}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-chart-area fa-sm text-white-50"></i> Update SKM</a>
                        @endforeach
                    </div>
